...
do
	...
	local left = {
		type = "recipe",
		name = "shuttle-left",
		icon = "__folk-shuttle-016__/graphics/left.png",
		icon_size = 32,
		enabled = false,
		energy_required = 300,
		ingredients = {
	...
	local right = {
		type = "recipe",
		name = "shuttle-right",
		icon = "__folk-shuttle-016__/graphics/right.png",
		icon_size = 32,
		enabled = false,
		energy_required = 300,
		ingredients = {
	...
	local item = {
		type = "item",
		name = "shuttle-lite",
		icon = "__folk-shuttle-016__/graphics/icon.png",
		icon_size = 32,
	...
	eq.sprite.filename = "__folk-shuttle-016__/graphics/icon.png"
	eq.shape.width = 2
	eq.shape.height = 2
	eq.power = "1W"
	...
	local tech = {
		type = "technology",
		name = "shuttle-lite",
		icon = "__folk-shuttle-016__/graphics/tech.png",
		icon_size = 128,
		effects = {
			{
				type = "unlock-recipe",
